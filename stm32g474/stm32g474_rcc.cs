...
namespace Antmicro.Renode.Peripherals.Miscellaneous
{
    ...
    public sealed class STM32_RCC : IDoubleWordPeripheral, IKnownSize, IProvidesRegisterCollection<DoubleWordRegisterCollection>
    {
        public STM32_RCC(IMachine machine, bool rtcPeripheral)
        {
            ...
            var registersMap = new Dictionary<long, DoubleWordRegister>
            {
                {(long)Registers.ClockControl, new DoubleWordRegister(this, 0x483)
                    ...
                    .WithFlag(9, FieldMode.Read, valueProviderCallback: _ => hsion.Value, name: "HSIKERON")
                    ...
                    .WithFlag(18, out var hsebyp, name: "HSEBYP")
                    .WithTag("CSSON", 19, 1)
                ...
                {(long)Registers.CalibrationRegister, new DoubleWordRegister(this)
                    .WithValueField(0, 8, name: "HSITRIM")
                    .WithValueField(8, 7, name: "HSICAL")
               ...
               {(long)Registers.ClockConfiguration, new DoubleWordRegister(this)
                ...
                {(long)Registers.PLLConfiguration, new DoubleWordRegister(this)
                    ...
                    .WithValueField(20, 1, name: "PLLQEN")
                    .WithValueField(21, 2, name: "PLLQ")
                    .WithReservedBits(23, 1)
                    .WithValueField(24, 1, name: "PLLREN")
                ...
                {(long)Registers.BackupDomainControl, new DoubleWordRegister(this)
                    ...
                    .WithFlag(15,  valueProviderCallback: _ => rtcPeripheral, name: "RTCEN")
                ...
                {(long)Registers.DedicatedClockConfiguration, new DoubleWordRegister(this)
                 ...
                 {(long)Registers.ClockRecoveryRCRegister, new DoubleWordRegister(this)
                    ...
                    .WithValueField(7, 8, name: "HSI48CAL")
        ...
        private enum Registers
        {
            ...
            //gap
            APB1PeripheralReset = 0x2C,
            APB2PeripheralReset = 0x30,
