...
namespace Antmicro.Renode.Peripherals.Miscellaneous
{
    ...
    public sealed class USB_HOST : IDoubleWordPeripheral, IKnownSize, IProvidesRegisterCollection<DoubleWordRegisterCollection>
    {
        public USB_HOST(IMachine machine )
        {
