...
namespace Antmicro.Renode.Peripherals.Analog
{
    ...
    public class STM32G474_ADC: IKnownSize, IProvidesRegisterCollection<DoubleWordRegisterCollection>, IDoubleWordPeripheral
    {
        public STM32G474_ADC(IMachine machine, double referenceVoltage, uint externalEventFrequency, int dmaChannel = 0, IDMA dmaPeripheral = null,
            int? watchdogCount = 1, bool? hasCalibration = true, int? channelCount = 19, bool? hasPrescaler = false,
            bool? hasVbatPin = true, bool? hasChannelSequence = true, bool? hasPowerRegister = false)
        {
        ...
        public void Reset()
        {
            ...
            samplingThread.Stop();
            adcChannelConfigReady.Value = true;
        }
        ...
        private Dictionary<long, DoubleWordRegister> BuildRegistersMap(bool hasCalibration, bool hasPrescaler, bool hasVbatPin, bool hasChannelSequence, bool hasPowerRegister)
        {
            var isrRegister = new DoubleWordRegister(this)
                ...
                .WithFlag(2, out endOfConversionFlag, FieldMode.Read | FieldMode.Write,  writeCallback: (_, val) =>
                    {
                        if(val)
                        {
                            this.Log(LogLevel.Warning, "EOC{0}", val);
                ...
                .WithFlag(13, out adcChannelConfigReady, FieldMode.Read | FieldMode.WriteOneToClear, name: "CCRDY");
            ...
            var registers = new Dictionary<long, DoubleWordRegister>
            {
                ...
                {(long)Registers.SamplingTime, new DoubleWordRegister(this)
                    .WithValueField( 0, 31, writeCallback: ( _, val) => {}, name:"SMP" )
                },
                ...
                {(long)Registers.DataRegister, new DoubleWordRegister(this)
                    .WithValueField(0, 16, out data, FieldMode.Read | FieldMode.Write, readCallback: (_, __) =>
                        {
        ...
        private IFlagRegisterField adcChannelConfigReady;

        private IValueRegisterField SamplingTimeSelection;
