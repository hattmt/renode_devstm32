...
{
    public class STM32G4DMA : IDoubleWordPeripheral, IKnownSize, IGPIOReceiver, INumberedGPIOOutput
    {
        public STM32G4DMA(IMachine machine, int numberOfChannels)
        {
        ...
        public void OnGPIO(int number, bool value)
        {
            ...
            {
                this.Log(LogLevel.Debug, "Enabled {0} value {1}", channels[number - 1].Enabled, channels[number - 1].dataCount.Value);
        ...
        {
            public Channel(STM32G4DMA parent, int number)
            {
                this.parent = parent;
            ...
            public IValueRegisterField dataCount;
            ...
            private readonly DoubleWordRegisterCollection registers;
            private readonly STM32G4DMA parent;
