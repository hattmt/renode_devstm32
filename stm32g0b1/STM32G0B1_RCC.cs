...
namespace Antmicro.Renode.Peripherals.Miscellaneous
{
    ...
    public sealed class STM32G0B1_RCC : IDoubleWordPeripheral, IKnownSize, IProvidesRegisterCollection<DoubleWordRegisterCollection>
    {
        public STM32G0B1_RCC(IMachine machine, bool rtcPeripheral)
        {
            ...
            var registersMap = new Dictionary<long, DoubleWordRegister>
            {
                {(long)Registers.ClockControl, new DoubleWordRegister(this, 0x483)
                    ...
                    .WithFlag(22, out var hsi48on, name: "HSI48ON")
                    .WithFlag(23, FieldMode.Read, valueProviderCallback: _ => hsi48on.Value, name: "HSI48RDY")
                ...
                {(long)Registers.ClockConfiguration, new DoubleWordRegister(this)
                    ...
                    .WithValueField(8, 4, name: "HPRE")
                    .WithValueField(12, 3, name: "PPRE")
                    .WithReservedBits(15, 1)
                },
