...
namespace Antmicro.Renode.Peripherals.Analog
{
    ...
    public class STM32G0B1_ADC: IKnownSize, IProvidesRegisterCollection<DoubleWordRegisterCollection>, IDoubleWordPeripheral
    {
        public STM32G0B1_ADC(IMachine machine, double referenceVoltage, uint externalEventFrequency, int dmaChannel = 0, IDMA dmaPeripheral = null,
            int? watchdogCount = 1, bool? hasCalibration = false, int? channelCount = 19, bool? hasPrescaler = false,
